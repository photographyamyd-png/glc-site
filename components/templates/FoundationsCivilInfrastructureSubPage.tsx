...
import { FOUNDATIONS_HUB_PATH } from "@/lib/site/foundations-civil-infrastructure-content";
    ...
    <article className="relative">
      <section className="hero-stage section-major band-dark-field relative min-h-[min(100dvh,880px)] scroll-mt-[var(--header)] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[min(100dvh,880px)] max-w-[min(100%,var(--max-bleed))] flex-col justify-end px-7 pb-10 pt-28 sm:px-10 lg:px-20 lg:pt-[calc(var(--header)+3rem)]">
          <div className="max-w-[min(100%,var(--max))] rounded-sm border border-white/10 bg-[rgb(10_12_11/0.45)] p-6 backdrop-blur-md sm:p-8 lg:max-w-4xl">
            ...
            <p className="mt-6 max-w-[40rem] text-[15px] leading-[1.72] text-white/90 sm:text-base">{content.heroLead}</p>
            {content.heroMore.length ? (
              <div className="mt-6 space-y-3 border-l-4 border-[color:var(--y)] pl-5">
      ...
      <section className="section-major band-dark relative scroll-mt-[var(--header)] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[min(100%,var(--max))] px-4 sm:px-6 lg:px-10">
          <div className="border-l-4 border-[color:var(--y)] pl-5">
            ...
            <p className="mt-4 max-w-3xl text-[15px] leading-[1.72] text-white/90 sm:text-base">{content.ctaParagraph}</p>
