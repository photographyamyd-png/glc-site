    ...
    >
      <div className="grid gap-4 sm:grid-cols-2">
        <article className="rounded-xl border border-[color:var(--g200)] bg-white/80 p-5 backdrop-blur-sm">
          <h2 className="font-serif text-xl font-bold uppercase tracking-tight text-ink">{CORE_COPY.about.operatingPrincipleHeading}</h2>
        ...
        <article className="rounded-xl border border-[color:var(--g200)] bg-white/80 p-5 backdrop-blur-sm">
          <h2 className="font-serif text-xl font-bold uppercase tracking-tight text-ink">{CORE_COPY.about.credentialsHeading}</h2>
