...
**Eyebrow typography:** Section eyebrows and kickers use the **`.eyebrow`** utility and updated **`.label-overline` / `.label-overline-on-dark`** (13px Source Sans 3, solid **`text-white`** on dark). Spec: [.cursor/rules/design-system.mdc](../.cursor/rules/design-system.mdc) (Typography lock and §6).
