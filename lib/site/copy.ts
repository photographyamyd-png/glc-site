...
export const SERVICE_DETAILS: Record<PrimaryServiceSlug, ServiceDetailCopy> = {
  ...
  "foundations-civil-infrastructure": {
    seoTitle: "Commercial Foundation Excavation Barrie | Civil Infrastructure | Ground Level",
    seoDescription:
      "Commercial foundation excavation, footings, shoring, trenches & structural backfill for GCs & developers in Barrie, Orillia, Innisfil, Wasaga Beach & Simcoe County.",
    hero: {
      breadcrumbParent: "Services",
  ...
  "snow-removal": {
    seoTitle: "Commercial Snow Removal Contractors | Barrie, Simcoe County",
    seoDescription:
    ...
    hero: {
      ...
      lede:
        "Seasonal contracts for plowing, salting, and ice control for commercial lots, roadways, and industrial yards.",
      body: [
        "Ground Level provides reliable winter maintenance for properties across Barrie, Midland, Orillia, and Simcoe County — with clear routes, documented service, and rapid response during storms.",
        "Ask about seasonal contracts and dispatch priority for multi-site portfolios that need consistent liability coverage and predictable mobilization.",
      ],
    },
    hubStats: [
      { value: "Seasonal", label: "Contracts", sub: "Commercial focus" },
      { value: "24hr", label: "Storm response", sub: "When contracted" },
      { value: "Lots +", label: "Roads", sub: "Industrial yards" },
    ],
    process: {
      eyebrow: "Winter operations",
      heading: "Monitor, dispatch, clear — document",
      steps: [
        { id: "01", title: "Storm watch", body: "Weather triggers and route priority aligned with your contract tier." },
        { id: "02", title: "Open lanes", body: "Plowing sequence for lots, drives, and critical fire routes first." },
        { id: "03", title: "Ice control", body: "Salt or melt products per site rules and environmental constraints." },
        { id: "04", title: "Stack & report", body: "Loader stacking where space is tight plus service logs for property teams." },
      ],
    },
    scopeStripLabels: ["Overview", "Scope", "Capabilities", "Process", "FAQ", "Related", "Get a quote"],
    intro: [
    ...
    trust: {
      id: "trust-snow",
      heading: "Commercial-only winter discipline",
      paragraphs: [
        "Snow contracts are about liability and access — not just blades. We document passes, ice treatments, and pile locations so property managers can answer tenants and insurers with confidence.",
        "Our operators understand commercial traffic patterns, loading docks, and fire routes so the first pass clears what matters most.",
      ],
    },
    subServices: [
      { id: "storm-operations-center", heading: "Storm operations center", paragraphs: ["Dispatch ties weather triggers to route maps so your sites get service priority per contract.", "Supervisors update crews on refreeze nights and shifting municipal conditions."], closing: "24/7 monitoring options for portfolio clients." },
      { id: "parking-lot-plowing", heading: "Parking lot plowing", paragraphs: ["Open lanes, islands, and end bays are cleared with blade patterns that minimize residual snow.", "We coordinate around corrals, bollards, and light bases to avoid equipment damage and claims."], closing: "Retail, office, and industrial lots." },
      { id: "roadways-yards", heading: "Roadways & yards", paragraphs: ["Private drives and yard routes stay passable for trucks and emergency vehicles with width and stacking plans.", "We maintain clear sight lines at intersections and gates where heavy equipment enters daily."], closing: "Industrial and logistics properties." },
      { id: "salt-ice-programs", heading: "Salt & ice melt programs", paragraphs: ["Application rates follow site environmental rules and owner preferences.", "We log passes and products when portfolios require traceability for audits or insurance."], closing: "Balanced ice control for liability." },
      { id: "loader-skid-steer-stacking", heading: "Loader & skid-steer stacking", paragraphs: ["High-volume winters demand pile management — we relocate or remove stacks when real estate runs out.", "Stacking plans consider drainage, sight lines, and spring melt impacts."], closing: "Tight urban and retail sites." },
      { id: "sidewalks-entrances", heading: "Sidewalks & entrances", paragraphs: ["Pedestrian priority zones are cleared before business openings where contracts require.", "We coordinate with facilities teams for interior slush and moisture-control impacts."], closing: "ADA-sensitive routes where required." },
      { id: "portfolio-seasonal-contracts", heading: "Portfolio & seasonal contracts", paragraphs: ["Multi-site contracts get consistent equipment, reporting, and escalation contacts.", "Renewals include preseason walkthroughs for hazard flags, pile locations, and priority maps."], closing: "Ask about priority dispatch tiers." },
    ],
    faq: [
      { q: "Do you offer seasonal contracts only?", a: "Seasonal agreements are typical for guaranteed response and documentation. Custom scopes are available for unique events." },
      { q: "How fast do you respond after a storm?", a: "Response follows contract tier and route priority, with realistic ETA communication during widespread events." },
      { q: "Can you provide service logs for insurance?", a: "Yes — service times, routes, and treatment products are documented where required." },
      { q: "What regions do you cover?", a: "Barrie, Midland, Orillia, and Simcoe County on commercial-focused routes." },
    ],
    ctaOverride: {
      heading: "Book your winter scope review",
      buttonLabel: "Call dispatch",
      supporting:
        "Walk your lot with us — we will map piles, priority lanes, and ice control products before the first storm.",
    },
    extra: {
      snowHub: {
        heroHeading:
        ...
        opening:
          "Ground Level Contracting is Simcoe County's dedicated commercial snow removal and ice management contractor, serving businesses in Barrie, Orillia, Innisfil, Wasaga Beach, and throughout the region.",
        valuePropHeading: "Why Businesses Choose Ground Level Contracting for Commercial Snow Removal",
        valuePropParagraphs: [
          "Commercial snow removal specialists deliver more than blades—they deliver business continuity for property managers, developers, engineers, and municipal-scale operations.",
          "When winter threatens uptime, liability exposure, and safe access for employees and freight, you need 24/7 emergency snow removal paired with accountability: GPS-tracked passes, ice management discipline, and contracts written for business operations.",
        ],
        lineBlockHeadings: [
          "Commercial Parking Lot Snow Plowing and Clearing",
          "Industrial Snow Removal (Warehouses, Distribution Centers, Factories)",
          "Commercial Ice Management and De-Icing Services",
          "24/7 Emergency Commercial Snow Removal",
          "Commercial Snow Hauling and Off-Site Removal",
          "Retail and Shopping Plaza Snow Removal",
          "Property Management Snow Removal Contracts",
          "Office Building and Corporate Campus Snow Removal",
        ],
        whyChooseHeading:
          "Why Simcoe County Businesses Choose Ground Level Contracting for Snow Removal",
        whyChooseItems: [
          "Commercial-only specialization",
          "24/7 emergency response and guaranteed service times",
          "Industrial and warehouse expertise",
          "GPS-tracked fleet and service verification",
          "High liability insurance for commercial operations",
          "Seasonal contracts with SLA guarantees",
          "Snow hauling and relocation capabilities",
          "Comprehensive ice management systems",
          "Property management and multi-site experience",
          "Safety-first commercial operations",
        ],
        propertyTypesHeading: "Commercial Snow Removal for Every Business Type",
        propertyTypes: [
        ...
        processHeading: "Our Commercial Snow Removal Process",
        processSteps: [
          "Free Commercial Property Assessment",
          "Contract and SLA Development",
          "Pre-Season Preparation",
          "Storm Monitoring and Dispatch",
          "Snow Removal and Ice Management",
          "Service Verification and Documentation",
          "Season-End Review and Planning",
        ],
        closingCtaHeading: "Ready to Ensure Your Business is Winter-Ready?",
        closingCtaParagraphs: [
          "Winter is an operational risk for commercial portfolios—downtime, slip-and-fall exposure, and tenant complaints escalate when snow removal is late or undocumented.",
          "Request a free commercial property assessment and receive a quote within 24–48 hours where scheduling allows.",
        ],
        closingCtaLabels: [
          "Request Free Commercial Assessment",
          "Call 24/7: 705-619-4902",
          "Download Contract Sample",
        ],
        faqLongFormTodo:
          "Detailed long-form answers are provided during onboarding so operations teams can align site priorities, service triggers, and documentation standards before the first event.",
      },
    },
  },
};
